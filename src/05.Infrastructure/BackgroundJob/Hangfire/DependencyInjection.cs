...
using Pertamina.SIMIT.Infrastructure.BackgroundJob.Hangfire.Storages.MySql;
using Pertamina.SIMIT.Infrastructure.BackgroundJob.Hangfire.Storages.SqlServer;
using Pertamina.SIMIT.Shared.Common.Constants;
using Pertamina.SIMIT.Shared.Common.Extensions;

namespace Pertamina.SIMIT.Infrastructure.BackgroundJob.Hangfire;
